...
extension [MessagePackValue] {
    ...
    public func parseObject<T: CustomDecodableRPCPayload>(type _: T.Type = T.self, indexPath: IndexPath) throws -> T {
        try T(values: self, indexPath: indexPath)
    }
    ...
    public func parseOptionalObject<T: DecodableRPCPayload>(type _: T.Type = T.self, indexPath: IndexPath) throws -> T? {
