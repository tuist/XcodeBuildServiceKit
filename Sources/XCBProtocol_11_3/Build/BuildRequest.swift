...
extension BuildRequest: DecodableRPCPayload {
    public init(args: [MessagePackValue], indexPath: IndexPath) throws {
        ...
        useLegacyBuildLocations = try args.parseBool(indexPath: indexPath + IndexPath(index: 12))
        shouldCollectMetrics = try args.parseBool(indexPath: indexPath + IndexPath(index: 13))
    }
}
